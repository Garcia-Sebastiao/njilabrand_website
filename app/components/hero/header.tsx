    ...
    <header className="w-full flex py-8 items-center">
      <nav className="w-full flex items-center justify-between max-w-6xl mx-auto">
        ...
        <ul className="flex items-center pl-32 gap-x-16">
          ...
          <Link href="#" className="text-white text-sm font-medium">About</Link>
          <Link href="#" className="text-white text-sm font-medium">Contact</Link>
        </ul>

        <button className="bg-white text-sm px-8 py-2 font-bold rounded-full">Contact-us</button>
      </nav>
    </header>
  );
}
